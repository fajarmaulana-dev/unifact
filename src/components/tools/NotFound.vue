...
<template>
    <section
        class="relative min-w-screen min-h-screen bg-gradient-to-b from-sky-300 via-sky-100 to-sky-300 dark:from-indigo-900 dark:via-indigo-800 dark:to-blue-400">
